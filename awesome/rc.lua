...
-- Don't draw gaps around single clients
...
globalkeys = my_table.join(
    ...
    -- Toggle picom
    awful.key({ modkey }, "grave", function () awful.spawn(string.format("sh %s/.config/scripts/toggle-picom.sh", os.getenv("HOME"))) end,
